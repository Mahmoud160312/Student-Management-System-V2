...
public class Settings extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(sp_setting, javax.swing.GroupLayout.DEFAULT_SIZE, 1237, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(sp_setting, javax.swing.GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE)
        );
    ...
    public static String getTimeForBack() {
    ...
    private void btn_backupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backupActionPerformed
        ...
        try {
            ...
            path = path.replace('\\', '/');
            path = path + "(" + date + ")" + ".sql";
            recordEvent("نسخ احتياطي", "اخذ نسخة احتياطية", "تم اخذ نسخة احتياطية و تحزينها في المكان "+path);
        ...
        try {
            ...
            if (processComplete == 0) {
                ...
                recordEvent("نسخ", "نسخ احتياطي", "تم اخذ نسخة احتياطية بنجاح");
            } else {
            ...
            if (replay == JOptionPane.YES_OPTION) {
                try {
                    ...
                    if (processComplete == 0) {
                        ...
                        recordEvent("استرجاع", "استرجاع نسخه احتياطية", "تم استرجاع نسخه احتياطية ");
                    }
                } catch (Exception ex) {
                    System.out.println(ex);
                }
    ...
    private void btn_pathActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pathActionPerformed
        ...
        try {
            ...
            path = f.getAbsolutePath();
            path = path.replace('\\', '/');
            recordEvent("نسخ احتياطي", "تغيير مكان النسخ الاحتياطي الاوتوماتيك", "تم تغيير مكان النسخ الاحتياطي الاوتوماتيك الى "+path);
            System.out.println(path);
        } catch (Exception ex) {
            System.out.println(ex);
        }
        try {
            ...
            stmt.executeUpdate();
            recordEvent("نسخ", "نسخ احتياطي تلقائي", "تم تغيير مكان النسخ الاحتياطي التلقائي");
    ...
    private void btn_footerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_footerActionPerformed
        ...
        try {
            ...
            stmt.executeUpdate();
            recordEvent("دباجة التقارير", "دباجة التقارير", "تم تغيير دباجة التقارير الى " + foot);
    ...
    private void btn_profileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_profileActionPerformed
        SecretaryProfile secretaryProfile = new SecretaryProfile();
        this.setVisible(false);
        secretaryProfile.setVisible(true);
