...
public class SecretaryDashBoard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pl_generalDashboardLayout.setHorizontalGroup(
            ...
            .addGroup(pl_generalDashboardLayout.createSequentialGroup()
                .addGap(229, 229, 229)
                .addComponent(pl_leftData, javax.swing.GroupLayout.DEFAULT_SIZE, 309, Short.MAX_VALUE)
                .addGap(177, 177, 177)
                .addComponent(pl_rightData, javax.swing.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
                .addGap(180, 180, 180))
        ...
        btn_viewStudentStaticsReport.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_viewStudentStaticsReportMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
            ...
            .addGroup(pl_theBestLayout.createSequentialGroup()
                ...
                .addGroup(pl_theBestLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pl_theBestLayout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(sp_bestStudentStaticsReport, javax.swing.GroupLayout.DEFAULT_SIZE, 787, Short.MAX_VALUE)
        ...
        pl_backgroundLayout.setHorizontalGroup(
            ...
            .addGroup(pl_backgroundLayout.createSequentialGroup()
                ...
                .addGap(0, 0, 0))
            .addGroup(pl_backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(reports, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1215, Short.MAX_VALUE))
        );
    ...
    private void cb_level3ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_level3ItemStateChanged
        ...
        try {
            ...
            st_totalCount = con.prepareStatement("select count(student_code) from student where level_name=?");
            st_totalCount.setString(1, level_name);
            res_totalCount = st_totalCount.executeQuery();
            while (res_totalCount.next()) {
                totalCount = res_totalCount.getString(1);
    ...
    private void btn_viewStudentStaticsReportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_viewStudentStaticsReportMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_viewStudentStaticsReportMouseClicked
